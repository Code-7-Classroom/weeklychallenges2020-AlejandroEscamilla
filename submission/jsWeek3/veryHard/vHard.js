...
// to be false. Also give the Programmer an 'acceptNewTask' method that updates the busy property on 
// that programmer to be true.

// 6. Give the Programmer an 'offerNewTask' method that console logs one thing if the programmer is 
// busy and another if the programmer is not, e.g. should initially log out "Mark can't accept any 
// new tasks right now." and "Mark would love to take on a new responsibility." if the programmer is
//  not busy.
...
// object.assign.prompt('Enter an exercise!');
person(exer).assign.prompt('enter an exercise');
